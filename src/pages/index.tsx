  ...
  return (
     <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
       <main>
         ...
         <h1 className='mt-14 text-white text-5xl font-bold leading-titht'>
         ...
         <form onSubmit={createPool} className='mt-10 flex gap-2'>
           <input 
            className="flex-1 px-6 py-4 rounded bg-gray-800 border bordr-gray-600 text-sm text-gray-100"
            type="text" 
            required 
